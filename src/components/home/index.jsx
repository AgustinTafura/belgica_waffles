...
const Home = () => {
    ...
    const data = [
        ...
        {title:"conservación", icon:'fas fa-snowflake', info:"NO UTILIZAMOS ADITIVOS NI CONSERVANTES ARTIFICIALES, SU MÉTODO DE PRESERVACIÓN ES EN FREEZER PARA QUE PUEDAN SER CONSERVADOS HASTA 6 MESES SIN PERDER SUS CUALIDADES NUTRICIONALES."}
    ]
