                        ...
                        <div className="tabs-container">
                            ...
                            <ul className="nav nav-tabs" id="ariaTabs" role="tablist">
                                <li className="nav-item">
                                    <span className="nav-link" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="false"><i className="fas fa-th"></i>CALIDAD</span>
                                </li>
                                <li className="nav-item">
                                    <span className="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="false"><i className="fas fa-th"></i>INSUMOS</span>
                                </li>
                                <li className="nav-item">
                                    <span className="nav-link active" id="nav-tab-3" data-toggle="tab" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="true"><i className="fas fa-th"></i>CONSERVACIÓN</span>
                                </li>
                            </ul>
